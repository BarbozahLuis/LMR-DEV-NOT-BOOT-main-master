...
function login(){
    var xemail = document.getElementById('lmail').value;
    var xsenha = document.getElementById('lsenha').value;

//se o espaço de email estiver vazio, imprima um alerta
if(xemail == ""){
    alert("Digite seu email")
}
//se o espaço senha estiver vazio, imprima um alerta
if(xsenha == ""){
